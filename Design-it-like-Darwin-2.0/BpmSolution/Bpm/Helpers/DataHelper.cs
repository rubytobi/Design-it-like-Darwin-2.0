...
namespace Bpm.Helpers
{
    public class DataHelper
    {
        public static void LoadDummyData()
        {
            ...
            ActivityInputHelper.Instance()
                .Add(new ActivityInputModel
                {
                    activityName = "a1",
                    objectName = "o1",
                    isInput = true
            ...
            ActivityOutputHelper.Instance()
                .Add(new ActivityOutputModel
                {
                    activityName = "a1",
                    objectName = "o3",
                    isOutput = true
            ...
            ActivityAttributeHelper.Instance()
        ...
        public class ActivityInputHelper
        {
            ...
            public HashSet<BpmnObject> RequiredInputObjects(BpmnActivity activity)
            {
                ...
                var y = Models.Where(x => x.isInput && x.activityName.Equals(activity.Name))
        ...
        public class ActivityOutputHelper
        {
            ...
            {
                // select all input object names for activity
                var y = Models.Where(x => x.isOutput && x.activityName.Equals(activity.Name))
                    .Select(x => x.objectName)
                    .ToList();
        ...
        public class ActivityAttributeHelper
        {
            ...
            {
                return Models.Where(x => x.decisionId.Equals(decisionId) && x.decisionValue.Equals(decisionValue))
                    .FirstOrDefault()
                    .decisionProbability;
            }
